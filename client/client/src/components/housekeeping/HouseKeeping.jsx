// client/src/components/housekeeping/HouseKeeping.jsx
...
import HousekeepingPlans from "./HousekeepingPlans";
...
const popularServicesData = [
  {
    name: "Packers & Movers",
    img: "https://i.pinimg.com/736x/87/70/98/8770987600f6b17471f3870056a54750.jpg",
    rating: 4.8,
    path: "/packersmovers",
  },
  {
    name: "Home Painting",
    img: "https://i.pinimg.com/1200x/bf/60/4f/bf604fa0b003445472ab8bf9388980d5.jpg",
    rating: 4.9,
    path: "/services/painting",
  },
  {
    name: "Home Renovation",
    img: "https://i.pinimg.com/1200x/fc/c2/6d/fcc26d313e54cfbba84011fe28f11da0.jpg",
    rating: 4.2,
    path: "/services/renovation",
  },
  {
    name: "Wall Panelling",
    img: "https://i.pinimg.com/736x/50/07/63/5007630ca03f65db9a2cec26671ee5bb.jpg",
    rating: 4.6,
    path: "/services/panelling",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 py-20 grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          <div>
            ...
            <p className="mt-5 text-gray-300 max-w-xl leading-relaxed text-lg">
              Experience spotless perfection with Edge Expert Housekeeping —
              deep cleaning, sanitization, and complete home care.
            </p>
          </div>
      ...
      <main className="bg-white text-black">
        ...
        <section className="max-w-7xl mx-auto px-6 py-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {popularServicesData.map((svc, idx) => (
              <div
                key={idx}
                className="relative rounded-xl overflow-hidden cursor-pointer shadow-lg hover:shadow-2xl transition-all"
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent p-4 flex flex-col justify-end text-white">
                  ...
                  <div className="mt-2 bg-white/20 px-2 py-1 rounded-full inline-flex items-center text-xs">
                    ⭐ {svc.rating}
                  </div>
                </div>
              </div>
