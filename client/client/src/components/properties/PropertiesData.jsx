const properties = [
  ...
  {
    id: 1,
    title: "Mahindra Roots - Luxury 3BHK",
    ...
    overview: {
      description:
        "An opulent residence by Mahindra Lifespaces in Kandivali West. Features smart home technology, national park views, and world-class amenities.",
    },
    details: {
      type: "Apartment",
      floor: "14 of 35",
      ...
      facing: "East",
      overlooking: "National Park, City Skyline",
      superArea: "1450 sq.ft",
      ...
      loanTenure: 20,
      monthlyEMI: 173560,
      totalInterestPayable: 21654400,
    },
    agent: {
      name: "Mahindra Sales Desk",
      email: "sales.roots@mahindralifespaces.com",
      phone: "+91 73853 27808",
      rating: 4.8,
      reviews: 32,
      specialTag: "Official Builder Partner",
    },
    price: "₹2.45 Cr",
    purpose: "Buy",
  ...
  {
    id: 2,
    title: "The Sarayu - 7-Star Luxury Land",
    ...
    overview: {
      description:
        "Iconic luxury gated villa plots on the banks of holy Sarayu River by HoABL. Managed by 5-star hotel The Leela with helipad and riverfront promenade.",
    },
    details: {
      ...
      furnishing: "N/A",
      facing: "East",
      overlooking: "Sarayu River, Temple Promenade",
    ...
    agent: {
      name: "HoABL Ayodhya Desk",
      email: "ayodhya@hoabl.in",
      phone: "+91 73853 27808",
      rating: 4.9,
      reviews: 50,
      specialTag: "Exclusive Partner",
    },
    price: "₹1.75 Cr",
    purpose: "Buy",
    tags: ["New", "Luxury"],
  ...
  // 4. PG Accommodation (Rent/Featured)
  {
    ...
    overview: {
      description:
        "High-end PG accommodation for students and media professionals in Lokhandwala Complex. Includes food, laundry, fast WiFi, and private/shared room options.",
    },
    details: {
      type: "PG / Co-living",
      floor: "2 of 7",
